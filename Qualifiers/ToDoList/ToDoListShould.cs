...
namespace ToDoList
{
    public class ToDoListShould
    {
        ...
        [Test]
        public void ConflictWithRegister()
        {
            list.AddEntry(42, userA, "Introduce autotests", 100);
            list.AddEntry(42, userB, "Introduce autotests111", 100);

            AssertEntries(Entry.Undone(42, "Introduce autotests"));
        }

        [Test]
        public void RemoveAndCreate_WithSameTimeStamp_ShouldRemove()
        {
        ...
        [Test]
        public void ConflictWithState_ShouldUndone()
        {
            list.AddEntry(42, userA, "Introduce autotests", 100);
            list.MarkUndone(42, userC, 105);
            list.MarkDone(42, userB, 105);
        ...
        [Test]
        public void OneElementInHistory()
        {
            list.AddEntry(42, userA, "Introduce autotests111", 100);
            list.AddEntry(42, userA, "Introduce autotests", 110);

            AssertEntries(Entry.Undone(42, "Introduce autotests"));
        }

        [Test]
        public void SortedHistory()
        {
            list.AddEntry(42, userB, "Introduce autotests5", 105);
            list.RemoveEntry(42, userA, 101);
            list.RemoveEntry(42, userB, 103);
            list.AddEntry(42, userA, "Introduce autotests", 110);
            list.RemoveEntry(42, userC, 102);
            list.MarkDone(42, userA, 104);
            list.AddEntry(42, userC, "Introduce autotests7", 106);
            list.MarkUndone(42, userC, 107);
        ...
        [Test]
        public void Not_Add_Item_When_It_Was_Removed_With_Greater_Timestamp()//(10,200)
        {
            list.RemoveEntry(42, userA, 110);
            list.AddEntry(42, userB, "Introduce autotests", 100);
